...
<div class="layout---line layout--weightRM-box">
    <div class="layout---unit">
        ...
        <h2 class="heading--smallcaps">deadlift <span class="result--heading"><?php echo $user['deadlift']; ?></span></h2>
        <h2 class="heading--smallcaps">benchpress <span class="result--heading"><?php echo $user['bench']; ?></span></h2>
...
<!-- script src="js/min/develop-min.js"></script-->
</body>
